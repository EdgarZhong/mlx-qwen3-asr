...
- Source: `/Users/dmoon/code/mlx-qwen3-asr/docs/benchmarks/2026-09-07-reference-parity-suite-multilingual100.json`
- Suite: `reference-parity-suite-v1`
- Model: `Qwen/Qwen3-ASR-0.6B`
- Samples: `100`
- Token match rate: `0.6600`
- Text match rate: `0.6800`
...
|---|---:|
| exact_match | 66 |
| minor_lexical_shift | 24 |
| numeric_surface_form | 5 |
| content_shift | 3 |
| punctuation_or_tokenization | 2 |
